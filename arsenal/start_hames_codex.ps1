...
$StartFile    = Join-Path $HamesRoot "ai_comm\Memory\.hames_start_codex.md"
...
$startupPrompt = @"
# Hames Codex Session Bootstrap

This file is the highest-priority bootstrap for the current Codex session.
...
Write-Host "=== CODEX STARTUP ===" -ForegroundColor Magenta
Write-Host ""
...
Write-Host "  Codex should read that file first through CLAUDE.md session override."
Write-Host ""
Write-Host "  ----------------------------------------------------------------"
